...
contract Signer {
    ...
    function initSign(string _documentId, string _initHash, string _email,string _email2, string _initTimestamp) public {
       signDetailsMap[_documentId] = Signdetails(_documentId,_initHash,'','',false,'',_email2,_initTimestamp,'');
    }
    //onlyOwner
